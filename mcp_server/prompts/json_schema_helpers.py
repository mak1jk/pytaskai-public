...
def get_json_output_instructions(schema_name: str, required_fields: List[str], 
                                optional_fields: Optional[List[str]] = None,
                                example_values: Optional[Dict[str, Any]] = None) -> str:
    """
    ...
    for field in required_fields:
        ...
        instructions.append(f'  "{field}": {example_val},  // REQUIRED: {get_field_description(field)}')
    
    # Add optional fields
    for field in optional_fields:
        field_type = get_field_type_hint(field, example_values.get(field))
        example_val = get_example_value(field, example_values.get(field), field_type)
        instructions.append(f'  "{field}": {example_val},  // OPTIONAL: {get_field_description(field)}')
...
def get_example_value(field_name: str, provided_example: Any = None, field_type: str = "string") -> str:
    ...
    if provided_example is not None:
        if isinstance(provided_example, str):
            ...
            return str(provided_example).lower() if isinstance(provided_example, bool) else str(provided_example)
...
def get_task_json_schema() -> str:
    ...
    return get_json_output_instructions(
        ...
        optional_fields=["estimated_hours", "complexity_score", "dependencies", "priority"],
        example_values={
...
def get_subtasks_json_schema() -> str:
    ...
    return get_json_output_instructions(
        ...
        optional_fields=["estimated_total_hours", "critical_path", "parallel_opportunities"],
        example_values={
