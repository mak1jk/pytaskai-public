...
class MinimalCLI:
    ...
    def cmd_next(self, args):
        ...
        if args.ignore_deps:
            ...
            if not available_tasks:
                print("No tasks available (pending tasks have unfulfilled dependencies).")
                return 0
        ...
        if args.json:
            ...
            print(f"🎯 Next Task: {next_task['id']} - {next_task.get('title', 'Untitled')}")
    ...
    def cmd_status(self, args):
        ...
        if self.save_tasks_direct(data):
            print(f"✅ Task {args.task_id} status updated: {old_status} → {args.new_status}")
            return 0
        else:
